 ...
 * @description netty 温度气压 服务端
 * history
 * <author>    <time>    <version>    <desc>
 * 作者姓名     修改时间     版本号        描述
 */
@Slf4j
public class NettyMeteServer {
    ...
    public static void initNettyServer(int port) throws InterruptedException {
        log.info("netty mete server 初始化 ...");
        try {
            ...
            count ++;
            log.info("netty mete server 初始化异常: {}, 准备第{}次重试...", e.getMessage(), count);
