...
@Slf4j
@Component
public class RobotSurveyJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        //设置下一次的采集时间，更新定时任务
//        String nextDateTimeInfo = updateJobCron(controlBoxId, serialNo, cycleInfo);
//        System.out.println("下次定时任务认识时间:" + nextDateTimeInfo);
        //执行本次采集任务
        SurveyBiz surveyBiz = ControlBoxHandler.getBoxSurveyBiz(controlBoxId);
        if (surveyBiz != null){
            //2025-04-01 修改:定时任务更新测量时间调整
            String nextDateTimeInfo = surveyBiz.updateJobCron(controlBoxId, serialNo);
     ...
     **/
    private String updateJobCron(Long controlBoxId, String serialNo, String cycleInfo) {
