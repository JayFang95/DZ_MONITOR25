 ...
 * @author jing.fang
 * @date 2025/7/9
 * @description 推送测点controller-中铁四局
 * history
 * <author>    <time>    <version>    <desc>
 * 作者姓名     修改时间     版本号        描述
 */
@RestController
@RequestMapping("/mt/common/pushPointCtce")
public class PushPointCtceController {

    @Autowired
    private IPushPointCtceBiz pushPointBiz;
    ...
    public ResponseUtil add(@RequestBody PushPointCtceVO data){
    ...
    public ResponseUtil addBatch(@RequestBody List<PushPointCtceVO> list){
    ...
    public ResponseUtil edit(@RequestBody PushPointCtceVO data){
