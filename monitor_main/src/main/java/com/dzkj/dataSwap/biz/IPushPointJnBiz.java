 ...
 * 作者姓名     修改时间     版本号        描述
 */
public interface IPushPointJnBiz {
     ...
     **/
    List<PushPointJnVO> queryList(Long taskId);
     ...
     **/
    ResponseUtil add(PushPointJnVO data);
     ...
     * @return: com.dzkj.common.util.ResponseUtil
     **/
    ResponseUtil addBatch(List<PushPointJnVO> list);
     ...
     * @return: com.dzkj.common.util.ResponseUtil
     **/
    ResponseUtil edit(PushPointJnVO data);
