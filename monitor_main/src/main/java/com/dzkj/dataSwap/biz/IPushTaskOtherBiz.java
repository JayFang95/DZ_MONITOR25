 ...
 * @author jing.fang
 * @date 2023/6/6 14:18
 * @description 推送任务(其他)业务接口
 * history
 * <author>    <time>    <version>    <desc>
 * 作者姓名     修改时间     版本号        描述
 */
public interface IPushTaskOtherBiz {
     ...
     **/
    List<PushTaskOtherVO> queryList(Long companyId);
     ...
     **/
    ResponseUtil add(PushTaskOtherVO data);
     ...
     * @return: com.dzkj.common.util.ResponseUtil
     **/
    ResponseUtil edit(PushTaskOtherVO data);
